...
| Failure cases | `figures/week8/failure_cases_ann_arbor_seed42.png` | Two lowest-PSNR Ann Arbor validation samples. |
...
- The failure cases show the dominant visual limitation: the model smooths
  high-frequency thermal detail around roofs, vehicles, and hard building
  edges. The uncertainty maps do not fully localize those errors.
